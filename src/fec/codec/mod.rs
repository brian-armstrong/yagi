...
pub use secded::{
    secded2216_decode, secded2216_decode_symbol, secded2216_encode, secded2216_encode_symbol, secded3932_decode,
    secded3932_decode_symbol, secded3932_encode, secded3932_encode_symbol, secded7264_decode, secded7264_decode_symbol,
    secded7264_encode, secded7264_encode_symbol, SecdedResult,
};
